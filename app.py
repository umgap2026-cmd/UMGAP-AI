...
def app_version():
    ...
    return jsonify({
        "latest_version": "1.3.6",      # ← update tiap rilis baru (samakan dgn "version:" di pubspec.yaml, TANPA +buildNumber)
        ...
        "message":        "Versi baru v1.3.6 tersedia!\n• Admin di Kasir & Keuangan sudah tidak menampilkan Laba/Untung (khusus Owner)\n• Hapus tombol jual-beli manual di Finance -- semua transaksi lewat pembuatan Nota"
    })
