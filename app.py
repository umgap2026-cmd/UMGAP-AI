...
def app_version():
    ...
    return jsonify({
        "latest_version": "1.2.6",      # ← update tiap rilis baru (samakan dgn "version:" di pubspec.yaml, TANPA +buildNumber)
